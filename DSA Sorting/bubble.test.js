...
describe('bubbleSort', function () {
  ...
  it('should sort numbers in ascending order', function () {
    ...
    const nums = [
      4, 3, 5, 3, 3, 43, 232, 4, 34, 232, 32, 4, 35, 34, 23, 2, 453, 546,
      75, 67, 4342, 32
    ];
    ...
    expect(bubbleSort(nums)).toEqual([
      ...
      546, 4342],
      "bubbleSort([4, 3, 5, 3, 3, 43, 232, 4, 34, 232, 32, 4, 35, 34, 23, 2, 453, 546, 75, 67, 4342, 32]) should equal [2, 3, 3, 3, 4, 4, 4, 5, 23, 32, 32, 34, 34, 35, 43, 67, 75, 232, 232, 453, 546, 4342]"
    );
  });
